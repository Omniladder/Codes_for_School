...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \solution{
            $\\.5 \times .3 + .5 \times .7 = .5$ thus we know there is a 
            50\%  chance of a choosing a coin and it landing on heads given 
            this with 3 flips we have $3 \times .5 = 1.5$ which is $\mu$ 
        ...
        \solution{
            ...
            we have the following formulas $\frac{1}{8} \left( 0-1.5 \right)^2 + \frac{3}{8} 
            \left( 1-1.5 \right)^2  + \frac{3}{8} \left( 2-1.5 \right)^2 + \frac{1}{8} 
            \left( 3-1.5 \right)^2 = .75 \\ \therefore \var{X} = .75$
        }
        \item Based on the number of heads we get, we earn $Y = \frac{1}{2 + X}$ dollars. 
        What is $\expec{Y}$?
        \solution{\\Plugging in the answer from problem 1 we know $E(X) = .5$ thus, $E(Y) = \frac{1}{2 + .75} = .\overline{36}$}
    \end{enumerate}
