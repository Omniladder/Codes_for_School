...
```         
There is generally a more even distribuition around the graph
```
...
Binom_plotter(36,.35,17,)
...
```{r}
Binom_plotter(36,.35,17.4,)
Binom_plotter(36,.35,17.6,)
```

Is there any difference in the late 2 probabilities? why or why not?

```         
no as all values are discrete so their nothing in that range thus the probability is the same
```
...
```{r}
Lambda = seq(0,100,by=5)
for (i in Lambda)
{
  p<-rpois(1000,i)
  hist(p, xlim=c(min(p) - 5 ,max(p) + 5))
}
```

```         
It seems that the data set always has a right ward skew with data slowly being more symmetric as Lambda grows
```
...
x_uniform<-seq(0,20, length=20)
y_uniform<- dunif(x_uniform,min=0,max=20)

Poisson = rpois(100,10)

Binomial <- rbinom(100, size = 50, prob = 0.6)
...
hist(Binomial, xlim=c(min(binomial_data) - 5 ,max(binomial_data) + 5))
...
```         
Sample 1 is Binomial due to both having high means unlike the others ranging generally in high 20s
Sample 2 is Poisson as both have low Means and variance
Sample 3 is Uniform as variance of both is high while mean is low
```
