...
4. since the sameple size n=73 > 40 It is a large sample since we are not gicen the population standard deviation sigma. We shhould use 1-sample t.
...
6. Using R to compute the p-value = .02718 < 0.05 = alphsa. This sample of 73 student's height provide sufficent evidence to reject HA
...
```         
1. Null: the mean height of the first grader in that region is equal to 43 inches
...
4. since the sameple size n=73 > 43 It is a large sample since we are not given the population standard deviation sigma. We should use 1-sample t.
