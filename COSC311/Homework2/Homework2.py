...
def grabData(randState):
    ...
    featureTrain, featureTest, classTrain, classTest = train_test_split(totalAttri, finalClass, test_size = .20, random_state= randState)

    return featureTrain, featureTest, classTrain, classTest 


def algorithm(featureTrain, featureTest, classTrain, classTest):
...
#Main Code 
featureTrain, featureTest, classTrain, classTest = grabData(0)
