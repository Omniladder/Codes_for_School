...
def explore_mlp_activations(
    ...
    # Generate plots for accuracy and loss across different activation functions
    visualize_configs(
        all_emb_epoch_dev_accs,
        activation_names,
        "Accuracy",
...
def explore_mlp_learning_rates(
    ...
    for i in lrs:
        ...
        visualize_configs(
            all_emb_epoch_dev_accs, lrs_names, "Accuracy", "./all_mlp_lrs_acc.png"
        )
        visualize_configs(
            all_emb_epoch_dev_losses, lrs_names, "Loss", "./all_mlp_lrs_loss.png"
        )
    # your code ends here
